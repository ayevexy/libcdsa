...
/**
 * @brief Creates a sequence with the specified elements.
 *
 * @param ... elements
 *
 * @return a newly created sequence
 *
 * @exception NULL_POINTER_ERROR if ... is null
 * @exception MEMORY_ALLOCATION_ERROR if memory allocation fails
 */
#define sequence_of(...) (sequence_of)(array_of(void*, __VA_ARGS__))

Sequence* (sequence_of)(Array(void*));
...
/**
 * @brief Creates a sequence of n elements generated by the given generator function.
 *
 ...
 * @return a newly created sequence
 *
 * @exception NULL_POINTER_ERROR if generator is null
 * @exception ILLEGAL_ARGUMENT_ERROR if limit < 1
 * @exception MEMORY_ALLOCATION_ERROR if memory allocation fails
 */
Sequence* sequence_generate(Supplier generator, int limit);

/**
 * @brief Creates a sequence from seed, using has_next to determine
 * when to stop and next to generate subsequent elements.
 *
 * @param seed the initial element
 * @param has_next the termination predicate
 * @param next the next-element generator
 *
 * @return a newly created sequence
 *
 * @exception NULL_POINTER_ERROR if has_next or next is null
 * @exception MEMORY_ALLOCATION_ERROR if memory allocation fails
 */
Sequence* sequence_iterate(void* seed, Predicate has_next, Operator next);

/**
 * @brief Closes the sequence without processing the pipeline.
 *
